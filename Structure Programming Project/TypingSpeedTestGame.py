...
cnx = mysql.connector.connect(
    ...
    user="root",   # username
    password="",  # password
    database="typingspeedgame"   # name of the database
)
...
def count():
    ...
    cursor.execute("INSERT INTO scores (wpmScore) VALUES (%s)", (wpm,))
    # Commit the changes
    cnx.commit()
...
def getHighScore():
    ...
    cnx = mysql.connector.connect(
        ...
        user="root",
        password="",
        database="typingspeedgame"
    )

    cursor = cnx.cursor()

    cursor.execute("SELECT wpmScore FROM `scores` ORDER BY `scores`.`wpmScore` ASC limit 1 ")
...
titleframe=Frame(mainframe,bg='goldenrod3')
titleframe.grid()

titleLabel=Label(titleframe,text='Speed Typing', font=('algerian',28,'bold') , bg='darkblue' ,fg='goldenrod3',width=38,bd=10)
...
elapsed_time_label=Label(frame_output,text='Elapsed Time',font=('Tahoma',12,'bold'),fg='goldenrod3')
...
remaining_time_label=Label(frame_output,text='Remaining Time',font=('Tahoma',12,'bold'),fg='goldenrod3')
remaining_time_label.grid(row=0,column=2,padx=5)

remaining_timer_label=Label(frame_output,text=totaltime,font=('Tahoma',12,'bold'))
remaining_timer_label.grid(row=0,column=3,padx=5)

wpm_label=Label(frame_output,text='WPM',font=('Tahoma',12,'bold'),fg='goldenrod3')
...
totalwords_label=Label(frame_output,text='Total Words',font=('Tahoma',12,'bold'),fg='goldenrod3')
...
wrongwords_label=Label(frame_output,text='Wrong Words',font=('Tahoma',12,'bold'),fg='goldenrod3')
...
accuracy_label=Label(frame_output,text='Accuracy',font=('Tahoma',12,'bold'),fg='goldenrod3')
...
highscoreLabel=Label(frame_output,text='Highscore:',font=('Tahoma',12,'bold'),fg='goldenrod3')
highscoreLabel.grid(row=0,column=12,padx=5)

highscoreLabelValue=Label(frame_output,text=getHighScore(),font=('Tahoma',12,'bold'))
highscoreLabelValue.grid(row=0,column=13,padx=5)
